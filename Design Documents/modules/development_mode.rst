...
.. plantuml::
   ...
   class DevelopmentMode {
     ...
     +deactivate()
     +is_active()
     +get_available_properties(player)
     +select_property(property_data)
     +can_build_house(property_data)
     +can_build_hotel(property_data)
     +build_house(property_data, player)
     +build_hotel(property_data, player)
     +sell_house(property_data, player)
     +sell_hotel(property_data, player)
     +get_house_cost(property_data)
     +get_hotel_cost(property_data)
     +check_even_development(property_data)
     +get_development_status(color_group, properties)
}}}}}}}}
...
.. plantuml::
   ...
   title DevelopmentMode Integration
   ...
   class GameLogic {
     +build_house(property, player)
     +build_hotel(property, player)
     +get_available_properties_for_development()
}}}
   ...
   class UI {
     +draw_development_ui()
     +handle_development_click()
}}}}}}}
   
   Game *-- DevelopmentMode
   DevelopmentMode --> GameLogic : uses
   DevelopmentMode --> Property : modifies
   DevelopmentMode --> Player : charges/refunds
   DevelopmentMode <--> UI : interacts with
...
.. plantuml::
   ...
   title Development Mode UI
   
   package "Development Mode UI" {
     rectangle "Property Grid" {
       card "Property 1" as P1
       card "Property 2" as P2
       card "Property 3" as P3
}}}
     
     rectangle "Selected Property Info" {
       rectangle "Property Name" as Name
       rectangle "Current Development" as Dev
       rectangle "Development Cost" as Cost
}}}}}}}}}}}}}}}}
     
     rectangle "Action Buttons" {
       rectangle "Build House" as BH
       rectangle "Build Hotel" as BHT
       rectangle "Sell House" as SH
       rectangle "Sell Hotel" as SHT
...
.. automodule:: src.DevelopmentMode
   :members:
   :undoc-members:
   :show-inheritance: